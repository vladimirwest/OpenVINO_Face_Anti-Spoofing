...
out_image = cv2.resize(input_img, (0,0), fx=0.75, fy=0.75) 
cv2.putText(out_image, 'Spoof probability: ' + str(sigmoid(out[0][0]))[0:5], (10,50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2, cv2.LINE_AA)
cv2.imshow('Spoof probability', out_image)
cv2.waitKey()